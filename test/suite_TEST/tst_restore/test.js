...
function main() {
    ...
    mouseClick(waitForObjectItem(names.stackedWidgetTreeViewQTreeView, "back\\_up\\_2"), 111, 16, Qt.NoModifier, Qt.LeftButton);
    mouseClick(waitForObjectItem(names.stackedWidgetTreeViewQTreeView, "back\\_up\\_2"), 111, 16, Qt.NoModifier, Qt.LeftButton);
    doubleClick(waitForObjectItem(names.stackedWidgetTreeViewQTreeView, "back\\_up\\_2"), 111, 16, Qt.NoModifier, Qt.LeftButton);
